...
| `jinteki-agenda-win.log` | real game (unanonymised version of built-in example 2) | Long Corp agenda win (25 rounds), net damage, Runner trashing Corp cards, two manual `/credit` adjustments by the Runner (turn 19), a spectator joining and leaving, `/save-replay`. Credit tracking matches every turn. No achievements. |
